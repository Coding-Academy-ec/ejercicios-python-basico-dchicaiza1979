...
if __name__ == "__main__":
    # Se llama a la función imprimir_datos_personales() con los datos personales
    print(imprimir_datos_personales("Dennis Chicaiza", 45, 1.64))
...
if __name__ == "__main__":
    ...
    # Se llama a la función suma() con los dos números ingresados y se imprime el resultado
